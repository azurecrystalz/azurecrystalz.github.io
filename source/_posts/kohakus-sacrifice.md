...
<div style="margin-top: 3%">
  ...
  ***
  ...
  {% bubble Kohaku %}
    ...
    <th>*(HiMERU-han really is the only one I can ask here…)*</th>
  {% endbubble %}
  ...
  ***
  ...
  {% bubble Rinne %}
    I'm Rinne-kuuun<sup>[1]</sup>. And I'm behind Kohaku-chyan right nyoooow…
  {% endbubble %}
  ...
  {% bubble Rinne %}
    Kohaku-chan! Give, give<sup>[2]</sup>! At this rate you'll break my arm! You'll break it clean off!
  {% endbubble %}
  ...
  {% bubble Niki %}
    n? Mrhff mrrrpgh~ (Welcome baaack~) Mogumogu<sup>[3]</sup>
  {% endbubble %}
  ...
  {% bubble Niki %}
    I really *was* gonna wait until everyone got back, y'know that? But I didn't know how long that was gonna take. I was stuck on what I should do until I heard Kohaku's scream from somewhere far off<sup>[4]</sup>.
  ...
  **[1]:** He used "atashi" here instead of "orecchi" (normally) or "ore" (speaking seriously)
  **[2]:** That's how it's written in the textbox in ktkn but in case the clarification is needed he's like saying "Uncle!"/"Give up"/"Get off" etc. Basically asking Kohaku to surrender.
  **[3]:** Like last time, the muffled noises are what's in the parenthesis, as you can see.
  **[4]:** Callback to the end of the prologue!!
